...
export default function SenatePage() {
  const { senateAmendments, loading, error } = useAmendments();
        ...
        <div className="md:flex md:items-center md:justify-between">
          <div className="flex-1 min-w-0">
            ...
            <p className="mt-1 text-sm text-gray-500">
              View all amendments from the Senate
            </p>
          </div>
        </div>
      </div>

      <AmendmentList amendments={senateAmendments} title="Senate Amendments" />
    </div>
  );
}
